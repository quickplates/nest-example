...
[`.github/workflows/lint.yaml`](https://github.com/quickplates/nest-example/blob/main/.github/workflows/lint.yaml).
...
You can find the `GitHub Actions` workflow that does this in
[`.github/workflows/registry.yaml`](https://github.com/quickplates/nest-example/blob/main/.github/workflows/registry.yaml).
...
You can find the `GitHub Actions` workflow that does this in
[`.github/workflows/docs.yaml`](https://github.com/quickplates/nest-example/blob/main/.github/workflows/docs.yaml).
